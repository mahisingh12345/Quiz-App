...
const quiz = [
...

    {
        ...
        choices: ["KeyWords.", "Data Type.", "Declaration Statement.", " Prototype."],
...

    {
        ...
        choices: ["stringfy().", "parse().", "convert.", " None of the above."],
        answer: "stringfy()."
    },

    {
        question: "Q. Which of the following are not server-side Javascript objects?",
